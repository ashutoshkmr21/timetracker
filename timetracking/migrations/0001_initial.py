...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TimeSheetData'
        db.create_table(u'timetracking_timesheetdata', (
            ...
            ('issue_description', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'timetracking', ['TimeSheetData'])


    def backwards(self, orm):
        # Deleting model 'TimeSheetData'
        db.delete_table(u'timetracking_timesheetdata')
